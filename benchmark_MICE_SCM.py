...
try:
    from single_run_impute_mice_scm_robust import run_single_trial
except ImportError:
    raise ImportError("Can't find single_run_impute_mice_scm_robust.py")
...
if __name__ == "__main__":
    ...
    print(f" Benchmark MICE + SCM robuste | {len(tasks)} runs")
    ...
    filename = f"RESULTS_MICE_SCM_ROBUST_{timestamp}.csv"
